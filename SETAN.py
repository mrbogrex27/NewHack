    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCKg0WtSkuzkA7SwBhv8AExw')
                time.sleep(2)
                menu()
